...
if (!empty($_SESSION['usuario'])) {
	...
	if (!empty($_SESSION['usuario']->pagamento)) {
...
//Quantidade de notificação
	$result_notificacoes = "SELECT count(ativa) FROM notificacao where vendedor_cpf = '$cpf_user' and ativa = 1;";
