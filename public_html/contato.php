            ...
            <div class="row" style="z-index: 0">
                ...
                <div class="navbar-collapse collapse" style="background-color: #996633" style="z-index: 0">
                    <ul class="nav navbar-nav" style="z-index: 0">
                        <li><a style="z-index: 0" href="index.php"><i class='fa fa-home'></i> Página Inicial</a></li>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <h5><a><i style="font-size:24px;color: #392613" class="fa fa-map-marker"></i></a> ENDEREÇO:<strong> Brasil, Minas Gerais, Belo Horizonte</strong>
                    </h5>
