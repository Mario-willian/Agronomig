...
<html lang="en">
  <head>
    ...
    <title>Agronomig | Configurações</title>
                ...
                <div class="col-md-4">
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li><a style="color: white" href="notificacao.php" class="w3-bar-item " title="Notificações"><i class="fa fa-bell"></i><span class=""><?php echo " ".$row_notificacoes['count(ativa)'];?></span> Notificações</a></li>                   
                            <li style='background-color: #392613'><a style="color: white" href="configs.php"><i class="fa fa-gear"></i> Configurações</a></li>
...
<center>
<form action="configs.php" method="get">
    <button style="width: 60%;"  name="excluir" onclick="myFunction()" class="btn btn-danger">Excluir Conta</button>
    <input type="text" style="display:none" value="<?php echo $cpf_user;?>" name="cpf">

</form><hr>

<a href=editar.php><button style="width: 60%;" name="editar" class="btn btn-warning">Editar Dados</button></a><hr>
</div>
