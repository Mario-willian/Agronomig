...
//Puxando variavel da Classe
require_once "../inc/conexao.php";

$codigo_produto = $_GET["codigo"];

//Impressao do historico de compras
$result_estoque = "SELECT * FROM estoque_vendedor where codigo_produto = $codigo_produto;";
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse" style="background-color: #996633">
                    <ul class="nav navbar-nav">
                        ...
                        <li style="background-color: #392613"><a href="estoque.php"><i class='fa fa-archive'></i> Estoque</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>Editar o Estoque do Produto</h2>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Seu Produto</h2>
    <form action="editar_estoque.php" method="get">
    <div class="form-group">
      <label for="nome">Nome do Produto:</label>
      <input required type="text" maxlength="80" disabled="" name="nome" value="<?php echo $row_estoque['produto']; ?>" class="form-control text-center">
    </div>

    <div class="form-group">
      <label for="quantidade">Quantidade:</label>
      <input required type="text" maxlength="80" name="quantidade" value="<?php echo $row_estoque['quantidade']; ?>" class="form-control text-center">
    </div>

    <div class="form-group">
      <label for="valor">Valor:</label>
      <input required type="text" maxlength="80" disabled="" name="valor" value="<?php echo $row_estoque['valor']; ?>" class="form-control text-center">
    </div>
    <input class="w3-input w3-border" name="codigo" style="display:none" type="text" value="<?php echo $row_estoque['codigo_produto']; ?>" >

    <br>

    <button style="width: 60%;" type="submit" name="alterar" class="btn btn-success">Salvar Alteração</button>
